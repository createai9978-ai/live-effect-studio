            ...
            <div className="flex items-center gap-3 border-b border-white/[0.05] bg-[#111218] px-4 py-2">
              ...
              <div className="flex items-center gap-2 text-[10px] text-zinc-500">
                <span className="hidden rounded border border-white/[0.06] px-1.5 py-0.5 md:inline">
                  {tab === "effects" ? currentCatLabel(activeCat) : TAB_META.find((t) => t.id === tab)?.label}
                </span>
                <button
                  title="Grid"
...
function currentCatLabel(id: string): string {
  return findCategory(EFFECTS_TREE, id)?.label ?? "Effects";
}
